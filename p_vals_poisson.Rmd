...
ggplot(data = df_power_null_hyp)+
  geom_line(aes(x = P, y = b_dist))+
  geom_line(aes(x = P, y = b_point), color = "red")+
  geom_line(aes(x = P, y = b_tail), color = "green")+
  geom_line(aes(x = P, y = b_double), color = "blue")+
  theme_classic()
```
